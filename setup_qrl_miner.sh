...
if [ ${#WALLET_BASE} != 79 -a ${#WALLET_BASE} != 80 -a ${#WALLET_BASE} != 99 -a ${#WALLET_BASE} != 81 ]; then
  echo "ERROR: Wrong wallet base address length (should be 106 or 95 or 99 or 79): ${#WALLET_BASE}"
  exit 1
fi
...
case $COUNTRY in
    "FR") URL="fr-qrl.miningocean.org" ;;
    "CA") URL="ca-qrl.miningocean.org" ;;
    "HK") URL="hk-qrl.miningocean.org" ;;
    "SG") URL="sg-qrl.miningocean.org" ;;
    *) URL="fr-qrl.miningocean.org" ;;
esac
